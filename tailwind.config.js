	...
	theme: {
		extend: {
			colors: {
				...
				surface0Dark: 'var(--surface-0-dark)',
				surface25: 'var(--surface-25)',
				surface25Dark: 'var(--surface-25-dark)',
				surface50: 'var(--surface-50)',
				surface50Dark: 'var(--surface-50-dark)',
				surface75: 'var(--surface-75)',
				surface75Dark: 'var(--surface-75-dark)',
