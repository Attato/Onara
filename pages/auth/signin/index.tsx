...
const SignIn = () => {
	...
	return (
		<>
			...
			<div className="flex min-h-screen flex-1 flex-col justify-center px-6 py-12 lg:px-8 bg-surface400 dark:bg-surface400Dark">
				<div className="w-full mx-auto mt-10 rounded-lg max-w-sm">
					<div className="flex items-center justify-center relative">
						...
						<span className="z-10 w-fit bg-surface400 dark:bg-surface400Dark px-6 ">
							Continue with
						</span>
					</div>
